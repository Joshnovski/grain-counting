...
tk.Label(root, text="Distance Transform Threshold:").grid(row=6, column=0, sticky='E')
tk.Entry(root, textvariable=config.distanceTransform_threshold).grid(row=6, column=2)

tk.Label(root, text="Dilation Iterations:").grid(row=7, column=0, sticky='E')
tk.Entry(root, textvariable=config.dilation_iterations).grid(row=7, column=2)

tk.Label(root, text="------------------------").grid(row=8, column=0, sticky='E')

tk.Label(root, text="Smaller Grain Area Min:").grid(row=9, column=0, sticky='E')
tk.Entry(root, textvariable=config.smaller_grain_area_min).grid(row=9, column=2)

tk.Label(root, text="Smaller Grain Area Max:").grid(row=10, column=0, sticky='E')
tk.Entry(root, textvariable=config.smaller_grain_area_max).grid(row=10, column=2)

tk.Label(root, text="Larger Grain Area Min:").grid(row=11, column=0, sticky='E')
tk.Entry(root, textvariable=config.larger_grain_area_min).grid(row=11, column=2)

tk.Label(root, text="Larger Grain Area Max:").grid(row=12, column=0, sticky='E')
tk.Entry(root, textvariable=config.larger_grain_area_max).grid(row=12, column=2)

tk.Label(root, text="Uncertain Grain Area Min:").grid(row=13, column=0, sticky='E')
tk.Entry(root, textvariable=config.uncertain_grain_area_min).grid(row=13, column=2)

tk.Label(root, text="Uncertain Grain Area Max:").grid(row=14, column=0, sticky='E')
tk.Entry(root, textvariable=config.uncertain_grain_area_max).grid(row=14, column=2)
