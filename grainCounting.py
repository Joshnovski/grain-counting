...
def count_chocolate_chips(image_path):
    # Load the image
    ...
    _, thresholded_image = cv2.threshold(gray_image, 160, 255, cv2.THRESH_BINARY)
    ...
    for contour in contours:
        ...
        if area > 60 and area < 6000: # Widen range here to allow for larger particle sizes
